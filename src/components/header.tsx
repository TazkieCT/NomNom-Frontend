            ...
            <div className="px-4 pt-4 pb-6">
              {isAuthenticated && user && (
                <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-50 text-red-700 mt-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                {isAuthenticated && user ? (
                  <>
                    ...
                    <button
                      onClick={handleLogout}
                      className="mt-2 w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-md flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
